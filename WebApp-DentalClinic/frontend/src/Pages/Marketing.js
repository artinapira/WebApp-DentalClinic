    ...
    <><section className="marketing-section">
      ...
      <div className="text-box-container">
        <div className="text-box">
          ...
          <p>
            <span className="title">Wondering Who To Trust With Your <span className="dental-care">Dental Care?</span></span>

            Welcome to our clinic,where we prioritize your smile's health and beauty.
            Our experienced team offers comprehensive dental solutions tailored to your needs,from routine
            check-ups to advance treatments.
          </p>
        </div>

      </div>

    </section><div className="image-container">
      ...
      </div><div className="icon-container1">
